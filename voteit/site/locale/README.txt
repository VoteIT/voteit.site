...
Extraction - from dir voteit/site:
i18ndude rebuild-pot --pot locale/voteit.site.pot --create voteit.site .
i18ndude sync --pot locale/voteit.site.pot locale/sv/LC_MESSAGES/voteit.site.po

(You need to install i18ndude before running the command. It's available on pypi.python.org)

Compiling with Babel
From the eggs root dir, Ie src/voteit.site in our current dev enviroment:
